...
//      print("weather data: ${response.body}");
  ...
  Future<WeatherForecastModel> getWeatherFore({String lats, String long}) async{
    _lats = lats;
    _long = long;
    var finalUrl = "https://api.openweathermap.org/data/2.5/forecast/daily?lat="+lats+"&lon="+long+
        "&appid="+Util.appId+"&units=metric"; //change to metric or imperial
  ...
  Future<WeatherForecastModel1> getWFH() async{
    ...
    var finalUrl = "https://api.openweathermap.org/data/2.5/onecall?lat="+_lats+"&lon="+_long+"&appid=751d7305f6f1ef6338c0998a6fbd2ccb&units=metric";//change to metric or imperial
